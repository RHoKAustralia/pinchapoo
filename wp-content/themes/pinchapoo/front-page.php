...
<div id="wrapper">
    ...
    <section id="banner">
        ...
        <article class="full">
            ...
            <a href="/about-us/what-is-pinchapoo/" class="image fit"><img src="<?php echo get_option('hero_image'); ?>" id="hero_image" alt="" data-position="center" /></a>
            <!--<div class="content">
            ...
            <div class="posts">
                ...
                <article>
                   <!-- <a href="/get-involved/fundraise/" class="image"><img src="< ?php bloginfo('template_url'); ?>/images/banner_16.png" alt="" /></a> -->
                    <a href="/get-involved/fundraise/" class="image"><img src="<?php echo get_option('fundraising_image'); ?>" alt="" id="fundraising_image" /></a>
                    <header>
