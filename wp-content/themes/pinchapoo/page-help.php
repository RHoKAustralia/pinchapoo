        ...
        <section class="main">
            <div class="posts">
                <article>
                    ...
                    <header>
                        <h2><a href="/who-we-help/community-organisations/">Community Organisations</a></h2>
                        <ul class="meta">
                            <!--<li>3 days ago</li>
                            <li><a href="#" class="favorites">2,174</a></li>
                            <li><a href="#" class="comments">1,423</a></li> -->
                    ...
                    <footer>
                        <ul class="actions">
                            <li><a href="/who-we-help/community-organisations/" class="button">Read More</a></li>
                        </ul>
                    </footer>
                </article>
                <article>
                    ...
                    <header>
                        <h2><a href="/who-we-help/school-support-program/">School Support Program</a></h2>
                        <ul class="meta"></ul>
                    </header>
                    <p>Words...</p>
                    <footer>
                        <ul class="actions">
                            <li><a href="/who-we-help/school-support-program/" class="button">Read More</a></li>
                        </ul>
                    </footer>
                </article>
                <article>
                    ...
                    <header>
                        <h2><a href="/who-we-help/i-need-help/">I Need Help</a></h2>
                        <ul class="meta"></ul>
                    </header>
                    <p>Words...</p>
                    <footer>
                        <ul class="actions">
                            <li><a href="/who-we-help/i-need-help/" class="button">Read More</a></li>
                        </ul>
                    </footer>
                </article>
            </div>
